...
<div class="container-fluid">
    ...
    <?php echo form_open(); ?> 
        ...
        <div class="form-group row">
            <label class="col-md-3 col-form-label text-right"> Service Name<span class="text-danger">&nbsp; *</span></label>
            <div class="col-md-4">
        ...
        <div class="form-group row">
            <label class="col-md-3 col-form-label text-right"> Description<span class="text-danger">&nbsp; *</span></label>
            <div class="col-md-4">
